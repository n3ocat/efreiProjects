	...
	public Location getLocation() {
		...
		try {
			...
			if (!isGPSEnabled && !isNetworkEnabled) {
				...
				Log.d("GPSTracker", "ERROR : No GPS status or network status !");
				...
				if (isNetworkEnabled) {
					...
					Log.d("GPSTracker", "Location by network");
				...
				if (isGPSEnabled) {
					...
					if (location == null) {
						...
						Log.d("GPSTracker", "Location by GPS");
